...
function App() {
    ...
    function fetchSortData(e) {
        setSelect(e.target.value)

        axios
            .get('/itemSearch',{params:{order:e.target.value}})
            .then(res => {
                setItems(res.data)
        ...
        <div>
            ...
            <div className="main-container">
                <div className="main-container-left">
                    <div className="container-left-text-link">
                        <p><span className="text-filters">Filters</span><a href="http://localhost:3000/" target="_blank">Clear All</a></p>
                    </div>
                    <div className="left-middle-text">
                        <h5 className="text-restaurants">Restaurants</h5>
                        <h5>Catering</h5>
                    </div>
                    <div className="left-buttons">
                        <button type="button" className="button-l-left">
                            <div className="button-div-left">Delivery</div>
                        </button>
                        <button type="button" className="button-l-right">
                            <div className="button-div-right">Pickup</div>
                        </button>
                    </div>
                    <div className="deliver-my-food">
                        <span>Deliver My Food</span>
                        <span>•</span>
                        <a href="javascript:void(0)">Today, ASAP</a>
                    </div>
                ...
                <div className="main-container-right">
                    ...
                    <div>
                        <div className="cuisine-elements">
                    ...
                    <div className="sort-search-bar">
                        ...
                        <select value={select} onChange={fetchSortData} className="select-control">
